  ...
  return (
    <div className="flex gap-2 font-rm-mont bg-rm-white p-1 rounded-full">
      <button
        ...
        className={`px-4 font-semibold rounded-full text-sm cursor-pointer transition-alll duration-300 ease-in-out ${
          viewMode === "all" ? "bg-rm-primary-500" : "bg-white text-gray-600"
        }`}
      >
        Todos
      </button>
